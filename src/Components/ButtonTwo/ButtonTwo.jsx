...
const ButtonTwo = ({ level }) => {
  return (
    <button className="relative inline-flex items-center px-12 py-3 bg-primary text-white overflow-hidden text-lg font-medium  border-2 border-primary rounded-full hover:text-white group hover:bg-gray-50">
